...
export const mapOverlays: MapOverlayElement[] = [
  ...
  },
  {
    ...
    coordinates: [1.1, 50.93],
    height: 52,
    href: "/assets/weather/battle-of-britain/morning-cloud-bank.png?v=20260614-comfy-weather-v4",
    label: "海峡低云",
    opacity: 0.2,
    drift: { dx: -7, dy: 3, phaseOffset: 1.2, scale: 0.01 },
    revealAt: "1940-09-15T10:30",
  ...
  },
  {
    ...
    coordinates: [0.02, 51.48],
    height: 48,
    href: "/assets/weather/battle-of-britain/morning-cloud-bank.png?v=20260614-comfy-weather-v4",
    label: "泰晤士云带",
    opacity: 0.18,
    drift: { dx: 5, dy: -5, phaseOffset: 2.1, scale: 0.008 },
    revealAt: "1940-09-15T10:30",
  ...
  },
  {
    ...
    coordinates: [0.94, 50.98],
    height: 54,
    href: "/assets/weather/battle-of-britain/afternoon-cloud-breaks.png?v=20260614-comfy-weather-v4",
    label: "肯特云隙",
    opacity: 0.2,
    drift: { dx: -6, dy: -4, phaseOffset: 1.6, scale: 0.01 },
  ...
  },
  {
    ...
    coordinates: [0.22, 51.52],
    height: 50,
    href: "/assets/weather/battle-of-britain/afternoon-cloud-breaks.png?v=20260614-comfy-weather-v4",
    label: "伦敦东侧云隙",
    opacity: 0.18,
    drift: { dx: 4, dy: 5, phaseOffset: 2.6, scale: 0.008 },
