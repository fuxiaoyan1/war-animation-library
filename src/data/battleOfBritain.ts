...
export const mapOverlays: MapOverlayElement[] = [
  {
    ...
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit morning-weather-overlay",
    coordinates: [0.5, 51.31],
    height: 104,
    href: "/assets/weather/battle-of-britain/morning-cloud-bank.png?v=20260614-comfy-weather-v4",
    label: "上午肯特破碎云朵",
    opacity: 0.42,
    drift: { dx: 2, dy: -1, phaseOffset: 0.2, scale: 0.002 },
  ...
  },
  {
    ...
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit morning-weather-overlay weather-overlay-secondary weather-overlay-channel",
    coordinates: [0.74, 51.12],
    height: 68,
    href: "/assets/weather/battle-of-britain/morning-cloud-bank.png?v=20260614-comfy-weather-v4",
    label: "海峡局部云朵",
    opacity: 0.35,
    drift: { dx: -1.5, dy: 1, phaseOffset: 1.2, scale: 0.002 },
    revealAt: "1940-09-15T10:30",
  ...
  },
  {
    ...
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit morning-weather-overlay weather-overlay-secondary weather-overlay-thames",
    coordinates: [0.1, 51.43],
    height: 64,
    href: "/assets/weather/battle-of-britain/morning-cloud-bank.png?v=20260614-comfy-weather-v4",
    label: "泰晤士局部云朵",
    opacity: 0.34,
    drift: { dx: 1.5, dy: -1.5, phaseOffset: 2.1, scale: 0.002 },
    revealAt: "1940-09-15T10:30",
  ...
  {
    id: "morning-comfy-cloud-medway",
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit morning-weather-overlay weather-overlay-secondary weather-overlay-medway",
    coordinates: [0.64, 51.4],
    height: 70,
    href: "/assets/weather/battle-of-britain/morning-cloud-bank.png?v=20260614-comfy-weather-v4",
    label: "梅德韦上空低云",
    opacity: 0.38,
    drift: { dx: -1.5, dy: -1, phaseOffset: 2.8, scale: 0.002 },
    revealAt: "1940-09-15T10:30",
    testId: "battle-of-britain-weather-overlay-morning-medway",
    type: "image",
    visibleUntil: "1940-09-15T13:10",
    width: 214
  },
  {
    id: "morning-comfy-cloud-tonbridge",
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit morning-weather-overlay weather-overlay-secondary weather-overlay-tonbridge",
    coordinates: [0.27, 51.2],
    height: 62,
    href: "/assets/weather/battle-of-britain/morning-cloud-bank.png?v=20260614-comfy-weather-v4",
    label: "汤布里奇破碎云",
    opacity: 0.36,
    drift: { dx: 1.5, dy: 1, phaseOffset: 3.5, scale: 0.002 },
    revealAt: "1940-09-15T10:30",
    testId: "battle-of-britain-weather-overlay-morning-tonbridge",
    type: "image",
  ...
  },
  {
    ...
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit afternoon-weather-overlay",
    coordinates: [0.42, 51.26],
    height: 100,
    href: "/assets/weather/battle-of-britain/afternoon-cloud-breaks.png?v=20260614-comfy-weather-v4",
    label: "午后局部云朵",
    opacity: 0.42,
    drift: { dx: 2, dy: 1, phaseOffset: 0.7, scale: 0.002 },
  ...
  },
  {
    ...
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit afternoon-weather-overlay weather-overlay-secondary weather-overlay-kent",
    coordinates: [0.72, 51.12],
    height: 70,
    href: "/assets/weather/battle-of-britain/afternoon-cloud-breaks.png?v=20260614-comfy-weather-v4",
    label: "肯特局部云朵",
    opacity: 0.36,
    drift: { dx: -1.5, dy: -1, phaseOffset: 1.6, scale: 0.002 },
  ...
  },
  {
    ...
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit afternoon-weather-overlay weather-overlay-secondary weather-overlay-estuary",
    coordinates: [0.84, 51.2],
    height: 66,
    href: "/assets/weather/battle-of-britain/afternoon-cloud-breaks.png?v=20260614-comfy-weather-v4",
    label: "伦敦东侧局部云朵",
    opacity: 0.34,
    drift: { dx: 1.5, dy: 1.5, phaseOffset: 2.6, scale: 0.002 },
  ...
  {
    id: "afternoon-comfy-cloud-medway",
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit afternoon-weather-overlay weather-overlay-secondary weather-overlay-medway",
    coordinates: [0.58, 51.38],
    height: 74,
    href: "/assets/weather/battle-of-britain/afternoon-cloud-breaks.png?v=20260614-comfy-weather-v4",
    label: "午后梅德韦云隙",
    opacity: 0.38,
    drift: { dx: -1.5, dy: 1, phaseOffset: 3.1, scale: 0.002 },
    revealAt: "1940-09-15T13:35",
    testId: "battle-of-britain-weather-overlay-afternoon-medway",
    type: "image",
    visibleUntil: "1940-09-15T17:10",
    width: 226
  },
  {
    id: "afternoon-comfy-cloud-channel-return",
    className: "battle-of-britain-weather-overlay battle-of-britain-cloud-unit afternoon-weather-overlay weather-overlay-secondary weather-overlay-channel-return",
    coordinates: [0.98, 50.99],
    height: 68,
    href: "/assets/weather/battle-of-britain/afternoon-cloud-breaks.png?v=20260614-comfy-weather-v4",
    label: "海峡返航云带",
    opacity: 0.35,
    drift: { dx: 1.5, dy: -1, phaseOffset: 3.8, scale: 0.002 },
    revealAt: "1940-09-15T14:05",
    testId: "battle-of-britain-weather-overlay-afternoon-channel-return",
    type: "image",
    visibleUntil: "1940-09-15T18:00",
    width: 210
  },
