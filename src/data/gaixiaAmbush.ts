...
export const battleEvents: GaixiaEvent[] = [
  ...
  },
  {
    ...
    summary: "韩信中军压住垓下西南，步兵、弩兵和骑兵在外土垒外展开，先封锁楚军营阵外缘。",
    detail: "楚军营阵仍然完整；汉军西路步兵、北岸弩兵、北西盾阵、东口弩网和中军指挥线同时出现，但都停在外土垒、营门和南口之外：这不是一圈装饰线，而是外线封锁、弩阵压制和机动预备队的组合。",
