  ...
  return (
    <CampaignMapAnimation
      ...
      focusSteps={[
        ...
        { fromProgress: timeline.dateToProgress("BCE-0049-08-01"), focus: "caesarWesternMediterranean" },
        { fromProgress: timeline.dateToProgress("BCE-0048-01-01"), focus: "caesarGreece" },
