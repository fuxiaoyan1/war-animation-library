...
- 背景配乐改为 `wikimedia-holst-mercury.ogg`，即 Holst《The Planets》中的 `Mercury, the Winged Messenger`，由 United States Air Force Heritage of America Band 演奏。该曲比此前临时使用的 `Rule, Britannia!` 更适合表现空战机动和紧张推进，并让伦敦空战恢复系列配乐唯一性门禁。
