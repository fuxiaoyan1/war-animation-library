...
- Cannae Roman/Carthaginian markers: `public/assets/unit-icons/cannae-roman-legion.webp`, `cannae-roman-cavalry.webp`, `cannae-carthaginian-infantry.webp`, `cannae-african-infantry.webp`, `cannae-carthaginian-cavalry.webp`, `cannae-numidian-cavalry.webp`, `cannae-hannibal-command.webp`, and `cannae-paullus-command.webp` are generated by `scripts/generate-cannae-unit-assets.mjs` from 0 A.D. unit portrait source images under `public/assets/unit-icons/source/cannae-0ad/`. Current source files are `0ad-rome-infantry-legionary.png`, `0ad-rome-cavalry-spearman.png`, `0ad-rome-hero-marcellus.png`, `0ad-cart-infantry-spearman.png`, `0ad-cart-champion-infantry.png`, `0ad-cart-cavalry-spearman.png`, `0ad-cart-cavalry-javelinist.png`, and `0ad-cart-hero-hannibal.png`. The script crops, tints, outlines, shadows, badges, and exports transparent WebP markers. `public/assets/unit-icons/source/cannae-0ad/LICENSE.txt` records the 0 A.D. licensing excerpt; 0 A.D. art is marked as Creative Commons Attribution-Share Alike 3.0 and requires attribution to Wildfire Games / 0 A.D. The earlier VHV/PNGIMG source-site attempt is rejected for Cannae runtime use and retained only as local trace material if present.
