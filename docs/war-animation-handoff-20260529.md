...
镜头规则：`1948-11-19T22:30` 起第二道围墙/内圩攻坚使用独立 `nianzhuangSecondWall` 近镜头，二维 scale 约为第一版第二道镜头的 1.5 倍，3D zoom 实测需在 `12.05` 以上；`1948-11-20T05:15` 起回缩到 `nianzhuangFinal`，确保 `05:30` 清剿事件恢复残点清剿比例。
