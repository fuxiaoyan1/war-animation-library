...
- 二次放大碾庄专用 SVG 画布到 `2400x1440`，并再次缩小步兵、炮兵、装甲和徽标，避免几十万人级战役被几个大图标挤成小示意图。
...
- 基本战术单位口径明确：华野以纵队表示战役级机动/攻坚方向，国民党军以军级扇区表示防御体系，村落阵地承接局部攻坚细节。
...
- 动画文本不得误写为双堆集或黄维。
- 碾庄画布必须保持 `2400x1440`；单位图标必须通过尺寸门禁，防止图标过大、地图过小再次回归。
